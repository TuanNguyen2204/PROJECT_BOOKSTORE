...
public class AdminManageProduct extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        List<Product> listProducts = new ProductDAL().getAllProduct();
        List<Categories> listCategories = new CategoriesDAL().getAllCategories();
        ...
        List<Product> list = new ProductDAL().getListByPage(listProducts, start, end);
